<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="fname" value="{{ __('F_Name') }}" />
            <x-input id="fname" type="text" class="block w-full mt-1" wire:model="state.fname" required autocomplete="fname" />
            <x-input-error for="fname" class="mt-2" />
        </div>

        <!-- L_Name -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="lname" value="{{ __('L_Name') }}" />
            <x-input id="name" type="text" class="block w-full mt-1" wire:model="state.lname" required autocomplete="lname" />
